// Архітектурне ядро Всесвіту. Версія 3.3. Протокол "Активація Порталів".
...
function initializeUniverse() {
    ...
    // --- ЗМІНИ ТУТ ---
    const PLANET_DATA = [
        { name: "Світ 1", size: 10, distance: 220, speed: 0.1, textureUrl: 'https://cdn.prod.website-files.com/687800cd3b57aa1d537bf6f3/687e6b9829eb2d0c5a1d1a83_1.1.png', hasMoon: true, description: "Опис для Світу 1...", url: "https://www.thesupremeinkdynasty.com/" },
        { name: "Світ 2", size: 8, distance: 280, speed: 0.08, textureUrl: 'https://cdn.prod.website-files.com/687800cd3b57aa1d537bf6f3/687e6b95e0b0e78f91b89f0e_2.1.png', description: "Опис для Світу 2...", url: "https://www.thesupremeinkdynasty.com/community" },
        { name: "Світ 3", size: 12, distance: 340, speed: 0.06, textureUrl: 'https://cdn.prod.website-files.com/687800cd3b57aa1d537bf6f3/687e6b96486c5b3d3b30f732_3.1.png', hasRings: true, description: "Опис для Світу 3...", url: "https://www.thesupremeinkdynasty.com/about-us" },
        { name: "Світ 4", size: 9, distance: 400, speed: 0.05, textureUrl: 'https://cdn.prod.website-files.com/687800cd3b57aa1d537bf6f3/687e6b95f5194ad7643a12c6_4.1.png', hasMoon: true, description: "Опис для Світу 4...", url: "https://www.thesupremeinkdynasty.com/hronic" },
    ...
    class CameraManager {
        ...
        configureControls() {
            this.controls.rotateSpeed = 2.0; this.controls.zoomSpeed = 1.2; this.controls.panSpeed = 0.8;
            this.controls.noZoom = false; this.controls.noPan = false; this.controls.staticMoving = true;
    ...
    class Universe {
        ...
        animate() {
            ...
            this.cameraManager.update(delta); // ЗМІНА ТУТ
